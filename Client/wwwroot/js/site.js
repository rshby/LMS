                                ...
                                <div class="card-body text-left">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 align-self-center">
                                            <h6 class="mb-1 font-weight-bold" ><a href="../class/details/${
                                              idx + 1
                                            }" style="color: black;">${
      val.class_Name
    }</a></h6>
                                            <p class="mb-0 text-truncate font-weight-light" style="width: 20rem; font-size: 13px;">${
                                              val.class_Desc
                                            }</p>
                                            <p class="mb-1"><button type="button" class="btn btn-outline-dark btn-sm" style="font-size: 13px; padding: 0px; border-style: hidden;">${
                                              val.category_Name
                                            }</button> <button type="button" class="btn btn-outline-info btn-sm mx-2" style="font-size: 13px; padding: 0px; border-style: hidden;">&nbsp;${bLevel}&nbsp;</button> <button type="button" class="btn btn-outline-warning btn-sm" style="font-size: 13px; padding: 0px; border-style: hidden;">&nbsp;★ ${bRating}&nbsp;</button></p>
        ...
        if (elm == val.category_Name) {
          ...
          cList += `<li><div class="col-sm">
            ...
            val.class_Name
                                            ...
                                            <p class="mb-0 text-truncate" style="width: 20rem; font-size: 13px;">${
                                              val.class_Desc
                                            }</p>
                                            <p class="mb-1"><button type="button" class="btn btn-outline-dark btn-sm" style="font-size: 13px; padding: 0px; border-style: hidden;">${
                                              val.category_Name
