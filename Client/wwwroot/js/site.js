                                ...
                                <div class="card-body text-left">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 align-self-center">
                                            <h5 class="mb-1 font-weight-bold"><a href="../class/details/${
                                              idx + 1
                                            }">${val.class_Name}</a></h5>
                                            <p class="mb-2 text-truncate" style="width: 20rem">${
                                              val.class_Desc
                                            }</p>
                                            <p class="mb-2"><button type="button" class="btn btn-outline-dark btn-sm disabled">${
                                              val.category_Name
                                            }</button> <button type="button" class="btn btn-outline-info btn-sm disabled">${
      val.level_Name
    }</button> <button type="button" class="btn btn-outline-warning btn-sm disabled">★${
      val.class_Rating
    }</button></p>
